...
const scopedCSS = `
  ...
  @media (max-width: 900px) {
    .rl-shell { padding: 0 28px !important; }
    .rl-portal { display: none !important; }
  }
  @media (max-width: 600px) {
    .rl-shell { padding: 0 18px !important; }
  }
`;
            ...
            <div style={styles.page}>
                ...
                <div style={styles.portalWrapper} className="rl-portal">
                    <div style={styles.liquidContainer}>
                        <div style={styles.liquidGlow} />
                        {/* Drops */}
                        <div style={{ ...styles.liquidDrop, ...styles.drop1 }} />
                        <div style={{ ...styles.liquidDrop, ...styles.drop2 }} />
                        <div style={{ ...styles.liquidDrop, ...styles.drop3 }} />
                        {/* Main Blob */}
                        <div style={styles.liquidBlobMain} />
                        <div style={styles.liquidBlobOverlay} />
                        <div style={styles.liquidBlobCore} />
                    </div>
                </div>
                ...
                <div style={styles.shell} className="rl-shell">
                    ...
                    <main style={styles.hero}>
                        <div style={styles.heroInner}>
                            <span style={styles.eyebrow}>Enterprise AI Integration</span>
                            <h1 style={styles.h1}>
                                Accelerate Growth
