...
const LandingPageDashboard = () => {
    return (
        <section id="dashboard" className="relative min-h-screen w-full flex flex-col items-center justify-center py-20 overflow-hidden bg-[#0f172a]">
            {/* Background Glow */}
            ...
            <ScrollReveal className="relative z-10 w-full max-w-6xl px-4 md:px-8" delay={0.2} variant="fadeInUp">
                {/* Floating Badges */}
