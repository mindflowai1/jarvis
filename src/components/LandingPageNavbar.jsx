        ...
        <nav className="fixed top-0 left-0 right-0 z-50 px-4 md:px-6 py-4 transition-all duration-300">
            <div className="max-w-7xl mx-auto glass-panel rounded-full px-6 py-3 flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                    {user ? (
                        <Link to="/dashboard" className="hidden md:flex text-slate-300 hover:text-white text-sm font-bold transition-colors">
                            Painel
                        </Link>
                    ) : (
                        <Link to="/login" className="hidden md:flex text-slate-300 hover:text-white text-sm font-bold transition-colors">
                            Login
                        </Link>
                    )}
