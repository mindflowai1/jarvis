...
const LandingPageShowcase = () => {
    return (
        <div id="showcase" className="bg-[#020c1b] text-white font-display overflow-x-hidden antialiased flex items-center justify-center min-h-screen p-4 sm:p-8">
                        ...
                        <div className="flex justify-end mb-4">
                            <div className="bg-[#005c4b] px-4 py-2.5 rounded-l-2xl rounded-br-2xl shadow-lg flex items-center gap-3">
                                ...
                                <div className="flex items-center gap-1">
                                    {[...Array(6)].map((_, i) => <div key={i} className="waveform-bar h-3 bg-[#25D366] rounded-full w-[3px]" style={{ height: [8, 16, 24, 14, 10, 20][i] + 'px' }}></div>)}
                                </div>
                        ...
                        <div className="flex justify-start mb-4">
                            <div className="bg-[#2bd4bd]/10 border border-[#2bd4bd]/15 rounded-tr-none rounded-2xl p-3 w-full max-w-[240px]">
                                <div className="bg-[#112240]/40 rounded-lg p-2 border border-white/5 flex items-center gap-3">
                                    <div className="size-8 bg-white rounded flex items-center justify-center shrink-0 text-[#020c1b] font-bold text-xs">
                                        M
                                    </div>
