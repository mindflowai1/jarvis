...
const styles = {
    page: {
        ...
        overflowX: 'hidden',
        overflowY: 'auto', // Permite rolar APENAS se a tela for menor que o próprio conteúdo
    },
    ...
    // ── Navbar ──
    navbar: {
        paddingTop: 'min(4vh, 36px)',
        paddingBottom: 'min(4vh, 36px)',
        display: 'flex',
        justifyContent: 'space-between',
        alignItems: 'center',
    },
    ...
    // ── Footer strip ──
    footer: {
        paddingTop: 'min(3vh, 20px)',
        paddingBottom: 'min(3vh, 20px)',
